...
function convertToHTML(jContent) {
    ...
    hStyle.textContent = "* { font-family: \"Segoe UI\", sans-serif; } [data-type=\"pt\"] { color: royalblue; } h1 { font-size: 200%; } h2 { font-size: 185%; } h3 { font-size: 170%; } h4 { font-size: 155%; } h5 { font-size: 140%; } h6 { font-size: 125%; } h1, h2, h3, h4, h5, h6 { text-align: center; }"
